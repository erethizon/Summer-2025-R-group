...
Here's my embarasing real example:

![Files pane with a hot mess in terms of organization.](images/file_pane_mess.png){fig-align="center"}

You can see from the above picture that we were using git (note the .git and .gitignore files), but I didn't really have a good grasp of version control at that point.
